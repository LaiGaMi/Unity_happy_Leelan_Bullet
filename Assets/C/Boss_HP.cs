    ...
    void SetPhase(BossPhase phase)
    {
        ...
        switch (phase)
        {
            case BossPhase.Phase1:
                ...
                if (spawnObject != null) spawnObject.SetActive(false);
                break;
